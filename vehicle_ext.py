...
#         ipdb.set_trace()
        ...
        for i, (image, phrase) in enumerate(zip(image, phrases), start=1):
            try:
                cv2.imwrite(f'{rfb_path}/{2}_{phrase}.jpg', image[..., ::-1])
            except:
                print('empty image!')
#                 import ipdb
#                 ipdb.set_trace()
...
if __name__ == '__main__':
    ...
    stage = "train"
    dinosam = DINOSAM("BAR_Contextual")  #   f"./{stage.upper()}_REGIONS_BY_PREDICTING_TOP6_ANOTHER"
