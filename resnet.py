...
def resnet18(dataset, kernel_size=3, pretrained=False):
    ...
    if dataset == 'tinyimagenet':
        model.fc3 = nn.Linear(model.l3.in_features, 200)
    elif dataset == 'food101':
        model.fc3 = nn.Linear(model.l3.in_features, 101)
    elif dataset == 'viero172':
        model.fc3 = nn.Linear(model.l3.in_features, 172)
    elif dataset == 'cifar100':
        model.fc3 = nn.Linear(model.l3.in_features, 100)
    elif dataset == 'cifar10':
        model.fc3 = nn.Linear(model.l3.in_features, 10)
    elif dataset == 'mnist':
        model.fc3 = nn.Linear(model.l3.in_features, 10)
    elif dataset == 'NICO_Animal':
        model.fc3 = nn.Linear(model.fc3.in_features, 10)
    elif dataset == 'NICO_Vehicle':
        model.fc3 = nn.Linear(model.fc3.in_features, 9)        
    model_name = 'resnet18'
    return model
